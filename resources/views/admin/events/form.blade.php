<x-forms.input name="topic" label="Event Name" type="text" id="topic" placeholder="Event Topic"
    value="{{ $event->topic ?? '' }}" />

<x-forms.input name="start_date" label="Start Date" type="date" id="start_date" value="{{ $event->start_date ?? '' }}" />
<x-forms.input name="end_date" label="End Date" type="date" id="end_date" value="{{ $event->end_date ?? '' }}" />
...
<div id="venue-details" class="form-group" style="display: none;">
    <x-forms.input name="venue_name" label="Venue" type="text" id="venue_name" placeholder="Enter Venue Details"
