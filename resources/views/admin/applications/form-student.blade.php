...
<x-forms.input name="phone_number" label="Phone Number" type="tel" id="phone_number" placeholder="Enter your phone number eg 0786065399" />
...
<x-forms.input name="institution_name" label="Title (Name of Institution)" type="text" id="institution_name" placeholder="Enter your institution name" />
<x-forms.input name="course" label="Course" type="text" id="course" placeholder="Enter the course you are pursuing" />
