            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ url('/admin/attendances/create') }}" class="btn btn-primary btn-sm" title="Add New training">
                            <i class="fa fa-plus" aria-hidden="true"></i> Add New
                        </a>

                        <!-- Search Form -->
                        <form method="GET" action="{{ url('/admin/attendances') }}" accept-charset="UTF-8"
                            class="form-inline my-2 my-lg-0 float-right" role="search">
                            <div class="input-group">
                                <input type="text" class="form-control" name="search" placeholder="Search..."
                                    value="{{ request('search') }}">
